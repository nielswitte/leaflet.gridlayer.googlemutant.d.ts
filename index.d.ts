...
// Definitions by: Ernest Rhinozeros <https://github.com/ernest-rhinozeros>, Niels Witte <https://github.com/nielswitte>
...
declare namespace L.gridLayer {
    interface GoogleMutant extends L.GridLayer {
        initialize(options: GoogleMutantOptions): void;
        setElementSize(e: HTMLElement, size: L.Point): void;
        addGoogleLayer(name: string, options?: GoogleMutantOptions): void;
        removeGoogleLayer(name: string): void;
        createTile(coords: [number, number] | [number, number, number], done?: any): HTMLElement;
    }
